				...
				<form action="<?php echo site_url('home/search'); ?>" method="GET">
		          <div class="row no-gutters addon_search_bar">
					...
					<div class="col-lg-1 col-sm-12">
						<input type="submit" value="" style="padding: 13px;padding: 16px 48px 13px 20px;margin-top: 5px;    border: none; background: #FFC107 url(<?php echo base_url()?>assets/frontend/images/search.svg) no-repeat center center;">
					</div>
				</div>
			   </div>
			 </form>
