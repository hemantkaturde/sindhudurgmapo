                ...
                <form action="<?php echo site_url('home/search'); ?>" method="GET">
                    <div class="row no-gutters addon_search_bar">
                        <div class="col-lg-3 col-sm-12 mb-1"
                            style="border-right: 1px solid #d2d8dd;width:100%;background:#fff">
                            <div class="form-group">
                                <input class="" type="text" name="search_string"
                                    placeholder="<?php echo get_phrase('what_are_you_looking_for'); ?>..."
                                    style="border: none;margin-top: 7px;">
                        ...
                        <div class="col-lg-2 col-sm-12 mb-1"
                            ...
                            <div class="input-group select-group">
                                ...
                                <select class="wide select-box" name="selected_category_id" id="selected_category_id"
                                    style="border: none;margin-top: 8px; font-size: 13px;">
                        ...
                        <div class="col-lg-2 col-sm-12 mb-1"
                            ...
                            <select class="wide" name="selected_taluka_id" id="selected_taluka_id"
                                style="border: none;margin-top: 8px; font-size: 13px;">
                                <option value="0"><?php echo get_phrase('all_taluka'); ?> /
                                    <?php echo get_phrase('cites'); ?></option>
                                <?php
							  $taluka = $this->crud_model->get_cities()->result_array();
							  foreach ($taluka as $taluka_value):?>
                                <option value="<?php echo $taluka_value['id']; ?>"><?php echo $taluka_value['name']; ?>
                                </option>
                                <?php endforeach; ?>
                            </select>
                        </div>

                        <select class="col-lg-2 col-sm-12 mb-1" name="selected_city_id" id="selected_city_id"
                            style="border: none;font-size: 13px;margin-top: 7px;">
                            <option value="0"><?php echo get_phrase('all_village'); ?> /
                                <?php echo get_phrase('area'); ?></option>
                        </select>

                        <div class="col-lg-1 col-sm-12">
                            <input type="submit" value=""
                                style="padding: 13px;padding: 16px 48px 13px 20px;    border: none; background: #FFC107 url(<?php echo base_url()?>assets/frontend/images/search.svg) no-repeat center center;">
                        </div>
                    </div>
            </div>
            </form>
    ...
    <div class="search_mob_wp">
        <div class="custom-search-input-2" style="margin-left: 15px;margin-right: 15px;">
            <form action="<?php echo site_url('home/search'); ?>" method="GET">
                ...
                <select class="wide" name="selected_taluka_id" id="selected_taluka_id"
                    style="border: none;margin-top: 8px; font-size: 13px;">
                    <option value="0"><?php echo get_phrase('all_taluka'); ?> / <?php echo get_phrase('cites'); ?>
                    </option>
                    <?php
							  $taluka = $this->crud_model->get_cities()->result_array();
							  foreach ($taluka as $taluka_value):?>
                ...
                <select class="wide" name="selected_city_id" id="selected_city_id"
                    style="border: none;font-size: 13px;margin-top: 7px;">
                    <option value="0"><?php echo get_phrase('all_village'); ?> / <?php echo get_phrase('area'); ?>
                    </option>
                </select>
    ...
    <div class="row justify-content-md-center">
                    ...
                    <div class="collapse show" id="collapseFilters">
                        <div class="filter_type" style="display: grid">
                            ...
                            <a data-toggle="collapse" href="#collapseExample1" aria-expanded="false"
                                aria-controls="collapseExample1" id="">Location<b></b></a>
                            <a data-toggle="collapse" href="#collapseExample2" aria-expanded="false"
                                aria-controls="collapseExample2" id="">Opening Status<b></b></a>
                            <a data-toggle="collapse" href="#collapseExample3" aria-expanded="false"
                                aria-controls="collapseExample3" id="">Media<b></b></a>
							      ...
							      foreach ($cities as $city):
									...
									?>
                                        <div class="card">
                                            <div class="card-head" id="headingOne">
                                                <h2 class="mb-0 " data-toggle="collapse"
                                                    ...
                                                    <li class="" style="list-style: none;">
                                                        <label class="container_check"> <i
                                                                class="<?php echo $city['icon_class']; ?>"></i>
                                                            <?php echo $city['name']; ?> <small></small>
                                                            <input type="checkbox" name="city[]" class="categories"
                                                                value="<?php echo $city['slug']; ?>"
                                                                onclick="filter(this, '<?php echo 'parent_id'.$city['id'] ?>')"
                                                                <?php //if(in_array($city['id'], $city_id)) echo 'checked'; ?>>
                                                            <span class="checkmark"></span>
                                                        </label>
                                                    </li>
                                                </h2>
										...
										$counter++;?>
                                                    ...
                                                    <li class="ml-3" style="list-style: none;">
                                                        <label class="container_check">
                                                            <?php echo $sub_village['name']; ?> <small></small>
                                                            <input type="checkbox" name="city[]"
                                                                class="categories <?php echo 'parent_id'.$city['id'] ?>"
                                                                value="<?php echo $sub_village['slug']; ?>"
                                                                onclick="filter(this)"
                                                                <?php //if(in_array($sub_village['id'], $city_id)) echo 'checked'; ?>>
                                                            <span class="checkmark"></span>
                                                        </label>
                                                    </li>
                                                    <?php endforeach; ?>
        ...
        <div class="col-lg-6 col-md-12 order-lg-1 order-2" id="listings">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 listing-div " data-marker-id="<?php echo $listing['code']; ?>"
                    ...
                    <div class="strip grid <?php if($listing['is_featured'] == 1) echo 'featured-tag-border'; ?>">
                        ...
                        <div class="wrapper <?php if($listing['is_featured'] == 1) echo 'featured-body'; ?>">
                            ...
                            <a class="address"
                                href="http://maps.google.com/maps?q=<?php echo $listing['latitude']; ?>,<?php echo $listing['longitude']; ?>"
                                target="_blank"><?php echo get_phrase('show_on_map'); ?></a>
                ...
                <?php } else { ?>
                <div>
                    <h3 style="margin-left: 51px; color: #ee0b46;"> No Record Found.. </h3>
                </div>
                <?php  }	?>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response, function(index, data) {
                    $('#selected_subcategory_id').append('<option value="' + data[
                        'id'] + '">' + data['name'] + '</option>');
                });
            }
        });
...
$('#selected_taluka_id').change(function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            // Add options
            $.each(response, function(index, data) {
                $('#selected_city_id').append('<option value="' + data['id'] + '">' + data[
                    'name'] + '</option>');
            });
        }
    });
