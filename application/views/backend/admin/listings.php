        ...
        <div class="panel-body">
          <form action="<?php echo site_url('admin/filter_listing_table') ?>" method="get">
              ...
              <div class="col-xs-4">
                <div class="form-group">
                  <div class="col-sm-12">
                    <select name="categories_id" id = "categories_id" class="select2 form-control" data-allow-clear="true" data-placeholder="<?php echo get_phrase('categories'); ?>">
                        <option value="all"><?php echo get_phrase('categories'); ?></option>
