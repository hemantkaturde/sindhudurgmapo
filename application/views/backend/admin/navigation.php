<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <!-- Category -->
        <li class="<?php if ($page_name == 'categories' || $page_name == 'category_add' || $page_name == 'category_edit') echo 'opened active has-sub'; ?>">
            <a href="#">
          ...
          <!-- <li class="<?php if ($page_name == 'sub_categories' || $page_name == 'sub_categories_add' || $page_name == 'sub_categories_edit'  ) echo 'opened active has-sub'; ?>">
            ...
            <ul>
                <li class="<?php if ($page_name == 'sub_categories') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/sub_categories_listing'); ?>">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('sub-categories'); ?></span>
                    </a>
                </li>

                <li class="<?php if ($page_name == 'sub_category_add') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/sub_category_form/add'); ?>">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('add_new_subcategory'); ?></span>
                    </a>
                </li>
            </ul>
        </li> -->
