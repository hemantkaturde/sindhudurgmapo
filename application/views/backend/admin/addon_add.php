			...
			<div class="panel-body">
				<form action="<?php echo site_url('admin/install_addon'); ?>" method="post" enctype="multipart/form-data">
					<div class="form-group">
						<label for="purchase_code"><?php echo get_phrase('addon_purchase_code'); ?></label>
						<input type="text" class="form-control" placeholder="<?php echo get_phrase('enter_your_valid_purchase_code'); ?>" name="purchase_code" id="purchase_code" required>
					</div>
					<div class="form-group">
